<template>
  <div class="max-w-xl w-full mx-auto bg-gray-900 rounded-xl overflow-hidden">
    <div class="max-w-md mx-auto pt-12 pb-14 px-5 text-center">
      ...
      <h4 class="text-xl text-gray-100 font-semibold mb-5">Your account is activated!</h4>
      <p class="text-gray-300 font-medium">Account has been verified Successfully.</p>
    </div>
