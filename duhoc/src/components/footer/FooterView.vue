<template>
  <footer class="bg-white text-base">
    <div class="mx-auto max-w-full overflow-hidden border-t-[1px] p-10">
      <div class="grid grid-cols-1 gap-8 pb-10 pc:grid-cols-3">
      ...
      <p class="border-t-[1px] pt-10 text-center text-base text-gray-600">
        &copy; 2024. TuanBV. All rights reserved.
      </p>
    </div>
  </footer>
</template>
