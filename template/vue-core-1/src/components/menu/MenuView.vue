...
<template>
  <header class="border-b-[1px] bg-gradient-to-r from-green-400 to-blue-500 text-white">
    ...
    <div
      class="wrapper lg:flex justify-between items-center lg:w-[80%] w-full mx-auto max-w-2xl lg:max-w-7xl"
