...
<template>
  <!-- Menu PC -->
	<nav class="relative px-4 py-4 flex justify-between items-center">
		...
		<div class="lg:hidden">
			<button class="navbar-burger flex items-center text-blue-600 p-3" @click.prevent="isMenuSp = !isMenuSp">
      ...
      <router-link v-for="item in menu" :key="item" :to="item.url" class="text-gray-500 text-sm font-medium">{{ item.name }}</router-link>
		</ul>
  ...
  <!-- Menu smartphone -->
	<div class="navbar-menu relative z-50" :class="isMenuSp ? '' : 'hidden'">
		...
		<nav class="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-white border-r overflow-y-auto">
            ...
            <router-link :to="item.url" class="block p-4 text-sm font-semibold text-gray-400 hover:bg-blue-50 hover:text-blue-600 rounded">{{ item.name }}</router-link>
					</li>
				</ul>
			</div>
			<div class="mt-auto">
